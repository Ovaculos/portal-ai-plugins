...
The marketplace also ships **shunt** (Claude Code only for now): a plugin that routes I/O-heavy agent work — bulk file reads and boilerplate generation — to a cheaper worker model via the Codex CLI. See [`plugins/shunt/README.md`](plugins/shunt/README.md).
...
claude plugin install shunt@portal   # optional: token-saving codex delegation
```
